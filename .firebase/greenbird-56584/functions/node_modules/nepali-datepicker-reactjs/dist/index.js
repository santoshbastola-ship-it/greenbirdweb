...
var bikramSambatJs = require('bikram-sambat-js');
...
var parseBSDate = function parseBSDate(date, separator) {
  ...
  var adDate = new Date(bikramSambatJs.BSToAD(date));
  var firstAdDateInBSMonth = new Date(bikramSambatJs.BSToAD(stitchDate({
    year: year,
    month: month,
    day: 1
  }, separator)));
...
var DayPickerBody = function DayPickerBody(_ref) {
  ...
  var getDayInfo = React.useCallback(function (weekNum, weekDayNum) {
    ...
    var today = splitDate(bikramSambatJs.ADToBS(new Date()));
...
var Calender = function Calender(_ref) {
  ...
  React.useEffect(function () {
    ...
    if (parsedDateValue) {
      ...
      var today = parseBSDate(bikramSambatJs.ADToBS(new Date()));
...
var NepaliDatePicker = function NepaliDatePicker(props) {
  ...
  React.useEffect(function () {
    setDate(toEnglish(value || (todayIfEmpty ? bikramSambatJs.ADToBS(new Date()) : "")));
  }, [value]);
